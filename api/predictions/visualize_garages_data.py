"""Visualize the data of each garage and save a plot."""
import datetime
...
def get_garages_data_for_predictions():
    """Get all garages data (date + space available)."""
    ...
    object_query = my_database.setup_query_extractor()
...
def visualize_and_process_garage(
    date_data, spaces_available_data, showing, which_garage, total_capacity
):
    """Visualize the data of each garage and save a plot if showing is enabled."""
    ...
    spaces_available_data_processed = np.where(
        spaces_available_data > total_capacity, total_capacity, spaces_available_data
    )  # Clean glitches of the API (values bigger than total capacity)
...
if __name__ == "__main__":
    ...
    (
        garage_A_time_series_dates_processed,
        garage_A_time_series_spaces_available_processed,
    ...
    (
        garage_B_time_series_dates_processed,
        garage_B_time_series_spaces_available_processed,
    ) = visualize_and_process_garage(
        garage_B_time_series_dates,
        garage_B_time_series_spaces_available,
        True,
    ...
    (
        garage_C_time_series_dates_processed,
        garage_C_time_series_spaces_available_processed,
    ) = visualize_and_process_garage(
        garage_C_time_series_dates,
        garage_C_time_series_spaces_available,
        True,
    ...
    (
        garage_D_time_series_dates_processed,
        garage_D_time_series_spaces_available_processed,
    ) = visualize_and_process_garage(
        garage_D_time_series_dates,
        garage_D_time_series_spaces_available,
        True,
    ...
    (
        garage_H_time_series_dates_processed,
        garage_H_time_series_spaces_available_processed,
    ) = visualize_and_process_garage(
        garage_H_time_series_dates,
        garage_H_time_series_spaces_available,
        True,
    ...
    (
        garage_I_time_series_dates_processed,
        garage_I_time_series_spaces_available_processed,
    ) = visualize_and_process_garage(
        garage_I_time_series_dates,
        garage_I_time_series_spaces_available,
        True,
