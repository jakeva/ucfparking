...
def processing_data(time_series_dates, time_series_spaces_available):
    ...
    garage_time_series_dates_processed = np.array(time_series_dates)
    garage_time_series_spaces_available_processed = np.array(time_series_spaces_available)
    garage_time_series_spaces_available_processed = (
        garage_time_series_spaces_available_processed.reshape(-1, 1)
    )
